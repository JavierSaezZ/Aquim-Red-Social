...
return [
    ...
    'password' => [
        ...
        'uncompromised' => 'La :attribute ha aparecido en una filtración de datos. Elige una :attribute diferente.',
    ],
    ...
    /*
    |--------------------------------------------------------------------------
    | MENSAJES EXACTOS DE LOS CAMPOS DE AQUIM
    |--------------------------------------------------------------------------
    */
    ...
    'custom' => [
        ...
        'code' => [
            'required' => 'Debes introducir el código de autenticación.',
        ],

        'name' => [
            'required' => 'El nombre es obligatorio.',
            'string' => 'El nombre no es válido.',
            'max' => 'El nombre no puede tener más de :max caracteres.',
        ],

        'nick' => [
            'required' => 'El nick es obligatorio.',
            'unique' => 'Ese nick ya está siendo utilizado.',
            'string' => 'El nick no es válido.',
            'max' => 'El nick no puede tener más de :max caracteres.',
        ],

        'email' => [
            'required' => 'El correo electrónico es obligatorio.',
            'email' => 'Introduce una dirección de correo electrónico válida.',
            'unique' => 'Ese correo electrónico ya está siendo utilizado.',
        ],

        'photo' => [
            'uploaded' => 'No se ha podido subir la foto.',
            'file' => 'La foto seleccionada no es válida.',
            'mimes' => 'La foto debe ser JPG, JPEG, PNG o WebP.',
            'max' => 'La foto no puede superar :max kilobytes.',
        ],
